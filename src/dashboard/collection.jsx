...
const Navbar = () => {
  return (
    <div className="bg-blue-700 p-4 shadow-md flex justify-between items-center">
      <div className="text-white font-bold text-xl">My Collection</div>
      ...
      <div className="p-6 mt-6">
        ...
        {posts && posts.length > 0 ? (
          <div className="space-y-6">
            {posts.map((post) => (
              <div key={post.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 border border-[#dfe3e8]">
                {/* Image or Video */}
